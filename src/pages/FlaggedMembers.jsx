...
import { AlertTriangle, FileText, Upload, CheckCircle, Clock, X } from 'lucide-react';
...
const FlaggedMembers = ({ user, onSignOut }) => {
  ...
  useEffect(() => {
    // Initial mock data
    setMembers([
      { id: 'MEM-4192', age: 68, sex: 'F', icd: 'J44.9', docsNeeded: 'Progress Notes' },
      { id: 'MEM-5543', age: 74, sex: 'M', icd: 'E66.01', docsNeeded: 'Lab Results, Discharge Summary' },
      { id: 'MEM-8821', age: 82, sex: 'M', icd: 'E11.9', docsNeeded: 'Specialist Consult' }
    ]);
  }, []);
  ...
  const handleUpload = (id) => {
    // Simulate upload -> status goes to Uploaded -> after 2s goes to Verified
